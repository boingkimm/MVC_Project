...
list3
		...
		<tr>
			...
			<td class="td_default" width="80"><%= num %>81</td>
			<td class="td_default" width="80"><img
				src="images/items/<%= gImage %>.gif" border="0" align="center"
				width="80" /></td>
			<td class="td_default" width="300" style='padding-left: 30px'><%= gName %>제나 레이스 스커트
				<br> <font size="2" color="#665b5f">[옵션 : 사이즈(<%= gSize %>L)
					, 색상(<%= gColor %>navy)]
			</font></td>
			...
			<input class="input_default" type="text" name="gAmount"
				...
				size="2" value="<%= gAmount %>3"></input></td>
